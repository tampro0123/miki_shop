...
const product = {
  ...
  policys: {
    ...
    paid_warrantys: ['Sửa độ rung với sản phẩm Ladanse', 'Làm mới sản phẩm'],
            ...
            <div className={cx('sup')}>
              {product.images.map((img, index) => {
                return (
                  ...
                  >
                    <Image src={img} className={cx('sup-img')} />
                  </div>
                );
              })}
            </div>
          ...
          <div className={cx('option-product')}>
            ...
            <div className={cx('rating')}>
              <div className={cx('rating-box')}>
                <div className={cx('rating-medium')}>{product.rating}</div>
            ...
            <div className={cx('price')}>
              <div className={cx('price-actual')}>{product.price} đ</div>
              <span className={cx('percent-sale')}>{product.sale}%</span>
            </div>
          ...
          <div className={cx('tab-detail')}>
            {productDetails.map((productDetail, index) => {
              return (
                ...
                >
                  {index === 3
                    ? productDetail + `(${product.commentsNumber})`
                    : productDetail}
                </div>
              );
            })}
