        ...
        <>
            ...
            <div className={cx("wrapper")}>
                <div className={cx("section")}>
                    <Image
                        src="section-product.jpg"
                        className={cx("img-section")}
                    />
                </div>
                        ...
                        >
                            ...
                            {isShowDrop && (
                                <div className={cx("dropdown")}>
                                    <div onClick={handleSortDefault}>
                                        Mặc định
                                    </div>
                                    <div onClick={handleSortAToZ}>A-Z</div>
                                    <div onClick={handleSortZToA}>Z-A</div>
                                    <div onClick={handleSortPriceUp}>
                                        Giá tăng dần
                                    </div>
                                    <div onClick={handleSortPriceDown}>
                                        Giá giảm dần
                                    </div>
