    ...
    <Fragment>
      ...
      <div className={cx('wrapper')}>
        <div className={cx('slogan')}>
          <Image className={cx('img-slogan')} src='main.jpg' alt='slogan' />

          <div className={cx('title')}>Thế Giới Nữ Trang</div>
          <div className={cx('slogan-text')}>
            <h2>Tôn vinh vẻ đẹp phái nữ - Trao quà tặng - Trao yêu thương</h2>
          </div>
        ...
        <div className={cx('aboutus')}>
          <div className={cx('aboutus-slogan')}>
            ...
            <p className={cx('content')}>
              ...
              những sản phẩm Nữ trang được đầu tư về thiết kế, minh bạch về
              thông tin giao dịch hàng hoá và mang đến khách hàng dịch vụ hậu
              mãi trọn vẹn.
            </p>
            <button className={cx('aboutus-btn')}>Tìm hiểu thêm</button>
          </div>
          <div className={cx('aboutus-img')}>
            <Image src='aboutus.jpg' className={cx('img')} alt='aboutus' />
          </div>
        </div>
        ...
        <div className={cx('collection')}>
          <Image className={cx('img-collection')} src='Frame 18.jpg' />
          <button className={cx('collection-btn')}>Tìm hiểu thêm</button>
        </div>
            ...
            <div className={cx('contain-left')}>
              <div className={cx('contain-top')}>
                <div className={cx('ring')}>
                  <Image className={cx('img-30')} src='footer3.jpg' />
                  <h3 className={cx('ring-h3')}>Nhẫn</h3>
                </div>
                <div className={cx('clock')}>
                  <Image className={cx('img-30')} src='footer5.png' />
              ...
              <div className={cx('contain-bottom')}>
                <div className={cx('bangles')}>
                  <Image src='footer4.jpg' className={cx('img-60')} />
                  <h3 className={cx('bangles-h3')}>Lắc tay</h3>
                </div>
                <div className={cx('necklace')}>
                  <Image src='footer1.jpg' className={cx('img-40')} />
                  <h3 className={cx('necklace-h3')}>Dây chuyền</h3>
                </div>
              </div>
            </div>
            <div className={cx('contain-right')}>
              <Image src='footer2.jpg' className={cx('img-100')} />
